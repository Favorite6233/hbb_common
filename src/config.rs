...
//    pub static ref APP_NAME: RwLock<String> = RwLock::new("RustDesk".to_owned());
    pub static ref APP_NAME: RwLock<String> = RwLock::new("RustDesk_Favorite6233".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rd.favorite6233.net"];
pub const RS_PUB_KEY: &str = "IDfviFYSYnHncspJGKTrSHTgbgt4BwlRaWfzgmaWSMQ=";
